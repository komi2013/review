...
class Controller_Mypage_TitleEnd extends Controller_All {
...
//     $quiz = ORM::factory('quiz')->where('enqu_id', '=', $this->enqu_id)->find();
    ...
    $this->template->content = View::factory('mypage/title_end');
    $this->template->content->enqu = $enqu;
//     $this->template->content->quiz = $quiz;
//     $this->template->content->my_list = 'quiz';
    $this->template->content->pre_url = '/answer/?enqu_id='.$this->enqu_id.'&qu_num=0';
